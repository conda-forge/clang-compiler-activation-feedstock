...
validate_recipe_outputs "clang-compiler-activation-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="clang-compiler-activation-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi